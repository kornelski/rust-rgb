...
mod test {
    ...
    fn test_add() {
        ...
        assert_eq!(
            RGBA::new_alpha(2u8, 4, 6, 8u16),
            RGBA::new_alpha(1u8, 2, 3, 4u16)
                + RGBA {
                    r: 1u8,
                    g: 2,
                    b: 3,
    ...
    fn test_checked_sub() {
        assert_eq!(
            RGB::<u8>::new(2, 4, 6).checked_sub(RGB::<u8>::new(3, 4, 6)),
            None
        );
        assert_eq!(
